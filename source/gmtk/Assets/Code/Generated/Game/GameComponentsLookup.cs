...
public static class GameComponentsLookup {
    ...
    public const int BuildingMode = 60;
    public const int GameplayMode = 61;
    public const int ModeHandler = 62;
    public const int ModeSwitched = 63;
    public const int Hole = 64;
    public const int HoleEntitySpawnData = 65;
    public const int SpawnAmount = 66;
    public const int SpawnInterval = 67;
    public const int SpawnTimeLeft = 68;
    public const int SpawnUp = 69;
    public const int CanBeInfectedByPoison = 70;
    public const int CanBeInfectedByRabies = 71;
    public const int CarrierOfInfection = 72;
    public const int CarrierOfInfectionId = 73;
    public const int CarrierOfPoisonInfection = 74;
    public const int CarrierOfRabiesInfection = 75;
    public const int ChanceToInfect = 76;
    public const int Infection = 77;
    public const int InfectionInterval = 78;
    public const int InfectionLayerMask = 79;
    public const int InfectionRadius = 80;
    public const int InfectionTrayLength = 81;
    public const int InfectionTrayWidth = 82;
    public const int InfectionType = 83;
    public const int InfectionUp = 84;
    public const int LevelInfection = 85;
    public const int PoisoningInfection = 86;
    public const int RabiesInfection = 87;
    public const int TimeLeftBeforeInfection = 88;
    public const int ValidInfection = 89;
    public const int Lose = 90;
    public const int Win = 91;
    public const int AmountConditionCompleted = 92;
    public const int AmountConditionUncompleted = 93;
    public const int Completed = 94;
    public const int ConditionsCompleted = 95;
    public const int ConditionsUncompleted = 96;
    public const int Failed = 97;
    public const int GameTaskStatusPanel = 98;
    public const int LevelTask = 99;
    public const int LevelTaskAmountConditionType = 100;
    public const int LevelTaskCommonRabbitAmount = 101;
    public const int LevelTaskConcreteRabbitAmount = 102;
    public const int LevelTaskCurrentCommonAmount = 103;
    public const int LevelTaskCurrentConcreteRabbitsAmount = 104;
    public const int LevelTaskDurationBeforeExpired = 105;
    public const int LevelTaskDurationBeforeExpiredTimeLeft = 106;
    public const int LevelTaskDurationLimitations = 107;
    public const int LevelTaskGoalForConcreteRabbits = 108;
    public const int LevelTaskMaxRabbitAmount = 109;
    public const int LevelTaskMinAmountType = 110;
    public const int LevelTaskMinRabbitAmount = 111;
    public const int LevelTaskRangeAmountType = 112;
    public const int LevelTaskRemoveAllRabbits = 113;
    public const int LevelTaskTargetHoldDuration = 114;
    public const int LevelTaskTargetHoldDurationTime = 115;
    public const int LevelTaskTimeExpired = 116;
    public const int LevelTaskType = 117;
    public const int LevelTaskWithHoldDuration = 118;
    public const int LevelTaskWithTimeForFail = 119;
    public const int NoChances = 120;
    public const int TimeConditionCompleted = 121;
    public const int TimeConditionUncompleted = 122;
    public const int TimeDurationConditionCompleted = 123;
    public const int TimeDurationConditionFailed = 124;
    public const int TimeHoldConditionCompleted = 125;
    public const int TimeHoldConditionUncompleted = 126;
    public const int Uncompleted = 127;
    public const int WaitingHoldTime = 128;
    public const int MoveDirection = 129;
    public const int MovementAvailable = 130;
    public const int Moving = 131;
    public const int Speed = 132;
    public const int TargetPoint = 133;
    public const int TargetPointReached = 134;
    public const int TurnedAlongDirection = 135;
    public const int ActivityFree = 136;
    public const int Alive = 137;
    public const int CanBeChosenForReplication = 138;
    public const int CanStartReplication = 139;
    public const int ChosenForReplication = 140;
    public const int ChosenForReplicationBy = 141;
    public const int CleanupMovingFinished = 142;
    public const int CleanupResetReplicationMarkers = 143;
    public const int CurrentReplicationDuration = 144;
    public const int Dead = 145;
    public const int DeadByInfection = 146;
    public const int DefaultReplicationDuration = 147;
    public const int InDanger = 148;
    public const int InSafety = 149;
    public const int InvalidReplicationTarget = 150;
    public const int MovingFinished = 151;
    public const int MovingInterval = 152;
    public const int MovingToReplicationTarget = 153;
    public const int MovingUp = 154;
    public const int NearReplicationTarget = 155;
    public const int OnGround = 156;
    public const int ProcessingDeath = 157;
    public const int Rabbit = 158;
    public const int RabbitAnimator = 159;
    public const int RabbitColorType = 160;
    public const int RabbitVisualChanger = 161;
    public const int Replicating = 162;
    public const int ReplicationAvailable = 163;
    public const int ReplicationBlocked = 164;
    public const int ReplicationExpired = 165;
    public const int ReplicationFinished = 166;
    public const int ReplicationInterval = 167;
    ...
    public const int TimeLeftForMoving = 173;
    public const int TimeLeftForNextReplication = 174;
    public const int ValidReplicationTarget = 175;
    public const int WaitingForMoving = 176;
    public const int WaitingForNextReplicationUp = 177;
    public const int WaitingReplicationTarget = 178;
    public const int WaitReplicationDuration = 179;
    public const int WaitReplicationTimeLeft = 180;
    public const int WantToReplicate = 181;
    public const int AfterDragPosition = 182;
    public const int CleanupUnselectMark = 183;
    public const int DragCanceled = 184;
    public const int DragFinished = 185;
    public const int Dragging = 186;
    public const int DragStarted = 187;
    public const int DragStopped = 188;
    public const int EntitiesForReleaseQueue = 189;
    public const int EntitiesForSelectionQueue = 190;
    public const int FollowSelectCenterSpeed = 191;
    public const int HasSelections = 192;
    public const int MoveToAfterDragPositionSpeed = 193;
    public const int MovingToAfterDragPosition = 194;
    public const int MovingToConveyorBeltAfterDrag = 195;
    public const int MultipleSelectionWindow = 196;
    public const int ReleaseFromDragUp = 197;
    public const int SavedPositionBeforeDrag = 198;
    public const int Selectable = 199;
    public const int SelectCenterPosition = 200;
    public const int SelectCenterRadius = 201;
    public const int Selected = 202;
    public const int SelectedEntities = 203;
    public const int Selection = 204;
    public const int SelectionDragMaxTime = 205;
    public const int SelectionDragTimeLeft = 206;
    public const int ShiftFromSelect = 207;
    public const int StoppedWaitingMouseDragFinish = 208;
    public const int UnselectSelectedEntities = 209;
    public const int WaitingMouseDragFinish = 210;
    public const int RabbitsAmount = 211;
    ...
    public static readonly System.Type[] componentTypes = {
        ...
        typeof(Code.Gameplay.Features.GameMode.BuildingMode),
        typeof(Code.Gameplay.Features.GameMode.GameplayMode),
        typeof(Code.Gameplay.Features.GameMode.ModeHandler),
        typeof(Code.Gameplay.Features.GameMode.ModeSwitched),
