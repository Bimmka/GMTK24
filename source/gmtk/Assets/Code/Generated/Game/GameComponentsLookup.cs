...
public static class GameComponentsLookup {
    ...
    public const int GameTaskStatusPanel = 77;
    public const int LevelTask = 78;
    public const int LevelTaskAmountConditionType = 79;
    public const int LevelTaskCommonRabbitAmount = 80;
    public const int LevelTaskConcreteRabbitAmount = 81;
    public const int LevelTaskCurrentCommonAmount = 82;
    public const int LevelTaskCurrentConcreteRabbitsAmount = 83;
    public const int LevelTaskDurationBeforeExpired = 84;
    public const int LevelTaskDurationBeforeExpiredTimeLeft = 85;
    public const int LevelTaskDurationLimitations = 86;
    public const int LevelTaskGoalForConcreteRabbits = 87;
    public const int LevelTaskMaxRabbitAmount = 88;
    public const int LevelTaskMinAmountType = 89;
    public const int LevelTaskMinRabbitAmount = 90;
    public const int LevelTaskRangeAmountType = 91;
    public const int LevelTaskRemoveAllRabbits = 92;
    public const int LevelTaskTargetHoldDuration = 93;
    public const int LevelTaskTargetHoldDurationTime = 94;
    public const int LevelTaskTimeExpired = 95;
    public const int LevelTaskType = 96;
    public const int LevelTaskWithHoldDuration = 97;
    public const int LevelTaskWithTimeForFail = 98;
    public const int NoChances = 99;
    public const int TimeConditionCompleted = 100;
    public const int TimeConditionUncompleted = 101;
    public const int TimeDurationConditionCompleted = 102;
    public const int TimeDurationConditionFailed = 103;
    public const int TimeHoldConditionCompleted = 104;
    public const int TimeHoldConditionUncompleted = 105;
    public const int Uncompleted = 106;
    public const int WaitingHoldTime = 107;
    public const int MoveDirection = 108;
    ...
    public const int TargetPointReached = 113;
    public const int TurnedAlongDirection = 114;
    public const int ActivityFree = 115;
    public const int Alive = 116;
    public const int AngryState = 117;
    public const int CanBeChosenForReplication = 118;
    public const int CanStartReplication = 119;
    public const int ChosenForReplication = 120;
    public const int ChosenForReplicationBy = 121;
    public const int CleanupMovingFinished = 122;
    public const int CleanupResetReplicationMarkers = 123;
    public const int CurrentReplicationDuration = 124;
    public const int Dead = 125;
    public const int DeadByInfection = 126;
    public const int DeadState = 127;
    public const int DefaultReplicationDuration = 128;
    public const int DraggingState = 129;
    public const int IdleState = 130;
    public const int InvalidReplicationTarget = 131;
    public const int MovingFinished = 132;
    public const int MovingInterval = 133;
    public const int MovingUp = 134;
    public const int NearReplicationTarget = 135;
    public const int ProcessingDeath = 136;
    public const int Rabbit = 137;
    public const int RabbitAnimator = 138;
    public const int RabbitColorType = 139;
    public const int RabbitNextSimpleState = 140;
    public const int RabbitStateMachine = 141;
    public const int RabbitVisualChanger = 142;
    public const int Replicating = 143;
    public const int ReplicationAvailable = 144;
    public const int ReplicationBlocked = 145;
    public const int ReplicationExpired = 146;
    public const int ReplicationFinished = 147;
    public const int ReplicationInterval = 148;
    public const int ReplicationState = 149;
    public const int ReplicationTarget = 150;
    public const int ReplicationTimeLeft = 151;
    public const int ReplicationTimeUp = 152;
    public const int ResetReplicationProcess = 153;
    public const int StallParentIndex = 154;
    public const int StupidMoveState = 155;
    public const int TimeLeftForMoving = 156;
    public const int TimeLeftForNextReplication = 157;
    public const int TransitionComplete = 158;
    public const int WaitingForMoving = 159;
    public const int WaitingForNextReplicationUp = 160;
    public const int WaitingReplicationTarget = 161;
    public const int WaitReplicationDuration = 162;
    public const int WaitReplicationTimeLeft = 163;
    public const int WantToReplicate = 164;
    public const int AfterDragPosition = 165;
    public const int CleanupUnselectMark = 166;
    public const int DragCanceled = 167;
    public const int DragFinished = 168;
    public const int Dragging = 169;
    public const int DragStarted = 170;
    public const int DragStopped = 171;
    public const int EntitiesForReleaseQueue = 172;
    public const int EntitiesForSelectionQueue = 173;
    public const int FollowSelectCenterSpeed = 174;
    public const int HasSelections = 175;
    public const int MoveToAfterDragPositionSpeed = 176;
    public const int MovingToAfterDragPosition = 177;
    public const int MultipleSelectionWindow = 178;
    public const int ReleaseFromDragUp = 179;
    public const int SavedPositionBeforeDrag = 180;
    public const int Selectable = 181;
    public const int SelectCenterPosition = 182;
    public const int SelectCenterRadius = 183;
    public const int Selected = 184;
    public const int SelectedEntities = 185;
    public const int Selection = 186;
    public const int SelectionDragMaxTime = 187;
    public const int SelectionDragTimeLeft = 188;
    public const int SelectionLayerMask = 189;
    public const int ShiftFromSelect = 190;
    public const int StoppedWaitingMouseDragFinish = 191;
    public const int UnselectSelectedEntities = 192;
    public const int WaitingMouseDragFinish = 193;
    public const int Stall = 194;
    public const int StallBounds = 195;
    public const int StallIndex = 196;
    ...
    public const int Period = 201;
    public const int PoisonStatus = 202;
    public const int RabiesStatus = 203;
    ...
    public const int ValidStatus = 209;
    ...
    public const int LayerMask = 213;
    public const int ProcessedTargets = 214;
    public const int Reached = 215;
    public const int ReadyToCollectTargets = 216;
    public const int TargetBuffer = 217;
    public const int TargetLimit = 218;
